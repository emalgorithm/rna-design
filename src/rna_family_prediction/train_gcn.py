...
from src.evaluation import evaluate_family_classifier, compute_metrics_family
...
parser.add_argument('--foldings_dataset', type=str,
                    default='../data/family_prediction/foldings.pkl', help='Path to foldings')

# parser.add_argument('--train_dataset', type=str,
#                     default='../data/family_prediction/dataset_Rfam_6320_13classes.fasta', help='Path to training dataset')
# parser.add_argument('--val_dataset', type=str,
#                     default='../data/family_prediction/dataset_Rfam_validated_2600_13classes.fasta', help='Path to val dataset')
...
model = GCN(n_features=opt.embedding_dim, hidden_dim=opt.hidden_dim, n_classes=n_classes,
            ...
            node_classification=False, residuals=opt.residuals, device=opt.device).to(opt.device)
